...
```{r }
library(tibble)
renv::install("SATVILab/DataTidyACSCyTOFCytokinesTCells")
load("cd4_th1_il17", "DataTidyACSCyTOFCytokinesTCells")
data_tidy_cd4_th1_il17 <- DataTidyACSCyTOFCytokinesTCells::cd4_th1_il17
count_tbl <- data_tidy_cd4_th1_il17$stats_combn_tbl
```
